...
echo "Running atlas-fullstack database migrations..."
migration up

echo "Initializing atlas-fullstack permissions..."
xtask init-permissions
xtask init-app-permissions

echo "Initializing atlas-fullstack root account..."
xtask init-root

echo "atlas-fullstack database initialization complete."
